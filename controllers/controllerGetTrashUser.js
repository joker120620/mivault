...
export async function getTrashUser(idUser) {
    try {
        ...
        const [images] = await db.query(`
            ...
            WHERE i.status_image = 'deleted' AND i.user_id_image = ?
        ...
        const [videos] = await db.query(`
            ...
            WHERE v.status_video = 'deleted' AND v.user_id_video = ?
        ...
        const [documents] = await db.query(`
            ...
            WHERE d.status_document = 'deleted' AND d.user_id_document = ?
